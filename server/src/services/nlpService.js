const intents = [
  ...
  { keys: ["check license", "license key", "software license", "subscription"], intent: "license_support", category: "software", answer: "To check a license, share the software name, license email or asset ID, and the exact activation message. Do not paste private license keys in chat." },
  { keys: ["share error code", "error code", "error message"], intent: "error_code_collection", category: "technical", answer: "Please share the exact error code, affected application, device or browser, and the action you were trying when it appeared." },
  { keys: ["install", "software", "application", "app", "license", "setup", "upgrade"], intent: "software_support", category: "software", answer: "For software support, confirm the application name, version, operating system, and any installation or license error shown." },
